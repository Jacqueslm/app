...
## SCHOOLS — moved to its own file

The schools pile now lives in **`SCHOOLS.md`**, with a real target list
attached — ten districts that publish a staff-wellness contact, plus all three
emails. Same rules: one a week, only after Tuesday's five rehab emails.
