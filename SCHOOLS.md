# SCHOOLS — the staff-wellness pile

**Same rules as OUTREACH.md.** Copy the subject, copy the body, paste, send,
tick the box. One a week, in the extra 15 minutes after Tuesday's five rehab
emails. No deadline on this pile.

**The one rule that matters: never mention money to a district.** Free
resource, opt-in, staff decide for themselves like any other app. The moment
pricing enters, procurement enters — W-9s, insurance certificates, board
approval, months. You're offering their newsletter a free item, not selling
them software. That's the whole trick, and it's why this works at all.

**What a "yes" actually looks like:** one paragraph in a staff wellness email
that reaches 500–5,000 people, at no cost. Not a contract. Then the next
district hears "we're already in [district]'s staff wellness resources."

Full strategy and the numbers behind it: `reference/SCHOOLS-BENEFITS-PLAYBOOK-2026-08.md`
...
one of them. Everything below came out of search results, so I have never laid
eyes on the pages themselves.

Every entry now says which kind of address it is:

- ***address confirmed in search*** — the address itself appeared in a result.
  Ten of the twelve.
- ***worked out from the format, not seen*** — the person and job title are
  real and published, but the address is built from the district's known email
  pattern. Two of the twelve: **Ladue** and **Mehlville**. Each has a named
  fallback under it.
...
confirmed*
**The names in the old note are out of date.** Brenda Tinsley retired and Kelly
Norrid took benefits; Britney Halpin moved to Coordinator of HR for Support
Staff. Rather than chase a moving job title, this goes to the person over the
whole department. Format is `lastnamefirstname@rsdmo.org` if you ever need to
work one out.
**Why them:** one of the largest districts in the region.
...
try jellis@ladueschools.net (Julie Ellis, HR Specialist, 314-983-5310).
...
`finitial+last` (asmith@ exists). If it bounces try scox@, then ring
(314) 467-5105 for Dr. Shannon Pike, Assistant Superintendent of HR.
...
I noticed Kirkwood already publishes a page of free behavioral health resources for staff, which is why I'm writing to you rather than somebody else — I'm not proposing you start anything, just offering one more free item for a list that already exists.
...
Resource Officer, dbesgrove@psdr3.org · (314) 213-8063.
...
Use their name if the page gives you one. Swap "local" for something true if
they're not near you — "one person, not a company" does the same job.

**Subject:** A free wellbeing resource for your staff newsletter

Hi,

I'm an app builder, and I'll keep this short because I know your inbox.
...
## EMAIL 2 — the follow-up (one week later, once, then let it go)

**Subject:** Re: (same subject)

Hi — floating this up once. One-line version: free, private wellbeing app for your staff (recovery + supporting a loved one), nothing for your office to run, and I'll write the newsletter blurb myself. Built by one guy who lived it: turnsomedayintodayone.com
...
## EMAIL 3 — when they say yes (send the same day, this IS the deliverable)
...
[New Canaan Public Schools](https://www.ncps-k12.org/page/employee-wellness) ·
[Middleton-Cross Plains](https://www.mcpasd.k12.wi.us/page/wellness) ·
[Brookings 05-1](https://www.brookings.k12.sd.us/page/staff-wellness) ·
[Dry Creek Joint Elementary](https://www.drycreek.k12.ca.us/staff/employee-wellness) ·
[Sun Prairie Area](https://www.sunprairieschools.org/departments/staff-wellness) ·
[Verona Area](https://www.verona.k12.wi.us/departments/humanresources/employee-benefits/additional-benefits) ·
[Campbell County](https://www.ccsd.k12.wy.us/staff/employee-wellness) ·
[Sheboygan Area](https://www.sheboygan.k12.wi.us/staff-wellness) ·
[Capital School District](https://www.capital.k12.de.us/departments/human_resources/wellness)
