...
//
// 98 days were rewritten with a line about that day. This test holds the line
// the other way: no line in the day table may appear on more than three days,
// so the next pass that fills the table by pattern fails here instead of on
// somebody's birthday.
//
...
test('no line in the day readings is used on more than three days', () => {
  const over = [...seen.values()].filter((e) => e.days.length > 3)
