...
Pro is an optional subscription for two things: Friendly — an AI companion to talk to at any hour — and the live community rooms. Every lesson, all ninety days on every track, and the whole 2AM tower are free with no card. Monthly and yearly plans both begin with a 7-day free trial, and there is a one-time lifetime option. You can cancel any time in two taps.
