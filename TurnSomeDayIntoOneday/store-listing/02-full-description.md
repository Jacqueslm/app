# Full description — DRAFT for Jacques to edit

Limit 4000 characters. Paste everything between the fences into Play Console →
Main store listing → Full description.

**The first paragraph is not optional and must not be moved or softened.** Play
rejects updates from non-regulated health apps that bury or omit it.
...
Pro is an optional subscription for two things: Friendly — an AI companion to talk to at any hour — and the live community rooms. Every lesson, all ninety days on every track, and The Fight of Your Life, the game, are free with no card. Monthly and yearly plans both begin with a 7-day free trial, and there is a one-time lifetime option. You can cancel any time in two taps.
...
- **No outcome claims.** Nothing says the app works, helps you quit, or improves
  anything. Every such sentence is a medical claim in this category.
- **Crisis language is present and specific.** Play looks for it in this space,
  and it is the right thing to have there regardless.
